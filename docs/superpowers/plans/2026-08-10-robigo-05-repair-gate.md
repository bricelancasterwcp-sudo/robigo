...
```bash
.venv/bin/robigo profile --model qwen2.5-coder:7b-instruct-q8_0 --window 8192 --seeds 1
.venv/bin/robigo profile --model qwen2.5-coder:7b-instruct-q8_0 --window 8192 --seeds 1
```
...
```bash
.venv/bin/robigo profile --model qwen2.5-coder:7b-instruct-q8_0 --window 8192 \
